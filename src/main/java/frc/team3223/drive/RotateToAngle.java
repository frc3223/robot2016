...
public class RotateToAngle implements ITableListener, PIDOutput, IDrive {
  ...
  public void valueChanged(ITable source, String key, Object value, boolean isNew) {
    ...
    switch (key) {
      /*
       * case "desired_heading": { double dvalue = (double) value; if(Math.abs(dvalue) > 180) {
       * turnController.setSetpoint(gyro.getAngle()); }else{ desiredHeading = dvalue;
       * turnController.setSetpoint(desiredHeading); } break; }
       */
      case "target_theta": {
